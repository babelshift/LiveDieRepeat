...
{
    public class MachineGunTripleBullet : ProjectileEntity
    {
        private static String ENTITY_DATA = "Entities/MachineGunTripleBullet";

        public MachineGunTripleBullet(ContentManager content)
