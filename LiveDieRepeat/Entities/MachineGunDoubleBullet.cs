...
{
    public class MachineGunDoubleBullet : ProjectileEntity
    {
        private static String ENTITY_DATA = "Entities/MachineGunDoubleBullet";

        public MachineGunDoubleBullet(ContentManager content)
