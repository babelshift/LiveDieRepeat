...
namespace LiveDieRepeat.Engine
{
    ...
    public abstract class ParticleSystem
    {
        ...
        protected ParticleSystem(MainGame game, int howManyEffects)
        {
            this.game = game;
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                MainGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity =
                MainGame.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                MainGame.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                MainGame.RandomBetween(minLifetime, maxLifetime);
            float scale =
                MainGame.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                MainGame.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = MainGame.RandomBetween(0, MathHelper.TwoPi);
        ...
        /// <summary>
        /// overriden from DrawableGameComponent, Draw will use MainGame's 
        ...
        public void Draw(GameTime gameTime, Camera camera)
        {
            ...
            game.SpriteBatch.Begin(SpriteSortMode.Deferred, blendState, null, null, null, null, camera.Transform * Resolution.getTransformationMatrix());
