...
{
    /// <summary>
    /// Entities must implement this interface if they want their collisions to be managed properly
    /// </summary>
    public interface ICollidable
    {
        ...
        IList<ICollidable> CollidableComponents { get; }
    }

    public static class CollisionManager
    {
        // grid manager used to maintain the grid used for collision detection
        ...
        public static void HandleCollisions(ICollidable collidableEntity, IEnumerable<ICollidable> collidableEntities2)
        {
        ...
        public static void HandleCollisions(IEnumerable<ICollidable> collidableEntities1, IEnumerable<ICollidable> collidableEntities2)
        {
        ...
        private static void AddCollidablesToGrid(IEnumerable<ICollidable> collidableEntities)
        {
        ...
        private static void DoCollisionResolution(ICollidable collidable)
        {
        ...
        /// <summary>We will assume that all entities in these lists are able to collide.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <typeparam name="T2"></typeparam>
        /// <param name="collidableEntity"></param>
        /// <param name="collidableEntity2"></param>
        /// <returns></returns>
        private static bool IsColliding(ICollidable collidableEntity, ICollidable collidableEntity2)
        {
