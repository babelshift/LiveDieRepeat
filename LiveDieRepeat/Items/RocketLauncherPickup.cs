...
{
    public class RocketLauncherPickup : ItemEntity
    {
        private static String ENTITY_DATA = "Item/RocketLauncherPickup";

        public RocketLauncherPickup(ContentManager content)
            : base(content, ENTITY_DATA)
        {
            WeaponAssociated = Factory<Weapon>.Create((int)EntityId.Weapon.RocketLauncher);
        }
