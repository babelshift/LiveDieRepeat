...
{
    public class FlameThrowerPickup : ItemEntity
    {
        private static String ENTITY_DATA = "Item/FlameThrowerPickup";

        public FlameThrowerPickup(ContentManager content)
            : base(content, ENTITY_DATA)
        {
            WeaponAssociated = Factory<Weapon>.Create((int)EntityId.Weapon.FlameThrower);
        }
