...
{
    public class GrenadeLauncherPickup : ItemEntity
    {
        private static String ENTITY_DATA = "Item/GrenadeLauncherPickup";

        public GrenadeLauncherPickup(ContentManager content)
            : base(content, ENTITY_DATA)
        {
            WeaponAssociated = Factory<Weapon>.Create((int)EntityId.Weapon.GrenadeLauncher);
        }
