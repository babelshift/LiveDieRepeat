...
{
    public class MineLayerPickup : ItemEntity
    {
        private static String ENTITY_DATA = "Item/MineLayerPickup";

        public MineLayerPickup(ContentManager content)
            : base(content, ENTITY_DATA)
        {
            WeaponAssociated = Factory<Weapon>.Create((int)EntityId.Weapon.MineLayer);
        }
