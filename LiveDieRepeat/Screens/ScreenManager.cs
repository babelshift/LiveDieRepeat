...
namespace LiveDieRepeat.Screens
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            font = content.Load<SpriteFont>("Fonts/ResagokrBold22");
            blankTexture = content.Load<Texture2D>("User Interface/blank");
        ...
        public void Deactivate()
        {
            ...
            using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
            {
                ...
                foreach (Screen screen in tempScreensList)
                {
                ...
                using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
                {
                    ...
                    using (IsolatedStorageFileStream stream = storage.OpenFile(StateFilename, FileMode.Open))
                    {
                        ...
                        foreach (XElement screenElem in doc.Root.Elements("Screen"))
                        {
                            ...
                            Screen screen = screenFactory.CreateScreen(screenType);
